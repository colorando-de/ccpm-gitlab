...
echo "  4. /pm:epic-sync <name>      - Push to GitLab"
...
echo "  /pm:epic-sync <name>      - Push epic and tasks to GitLab"
...
echo "  /pm:epic-mr <name>        - Create merge request for epic"
echo "  /pm:epic-merge <name>     - Merge epic to main (or cleanup after MR)"
echo "  /pm:epic-cleanup <name>   - Clean up after merged MR"
echo ""
echo "📝 Issue Commands"
...
echo "  /pm:issue-sync <num>      - Push updates to GitLab"
...
echo ""
echo "🔗 Sync Commands"
echo "  /pm:sync               - Full bidirectional sync with GitLab"
echo "  /pm:import <issue>     - Import existing GitLab issues"
echo ""
...
echo "  /pm:init               - Install dependencies and configure GitLab"
