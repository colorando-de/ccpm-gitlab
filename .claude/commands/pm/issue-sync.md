...
0. **Repository Protection Check:**
   ...
   if [[ "$remote_url" == *"your-org/ccpm-gitlab"* ]]; then
...
2. **Issue Validation:**
   - Run: `glab issue view $ARGUMENTS --json state`
...
```bash
glab issue comment #$ARGUMENTS --description-file {temp_comment_file}
```
...
github: https://gitlab.com/{org}/{repo}/issues/$ARGUMENTS
---
```
